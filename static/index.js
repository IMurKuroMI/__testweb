...
function shareText(score) {
    ...
    SubmitResults();
    if (score < 0) return '？';
    if (score <= 19) return '丢人（指指点点';
    if (score <= 50) return '就这？';
    if (score <= 99) return '狡猾的0';
    if (score <= 149) return '瓜瓜🍉看了都好了';
    if (score <= 199) return '您能把🍉按在地上⚪';
    if (score <= 249) return '1囡 酮 王1';
    return '恭迎火系大魔法师';
}
